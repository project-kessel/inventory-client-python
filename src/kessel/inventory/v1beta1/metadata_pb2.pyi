...
class Metadata(_message.Message):
    __slots__ = ("id", "resource_type", "first_reported", "last_reported", "first_reported_by", "latest_reported_by", "workspace", "tags")
