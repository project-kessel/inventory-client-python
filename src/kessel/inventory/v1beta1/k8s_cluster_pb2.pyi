...
from kessel.inventory.v1beta1.k8s_cluster_detail_pb2 import K8sClusterDetail as K8sClusterDetail
...
class K8sCluster(_message.Message):
    __slots__ = ("metadata", "reporter_data", "reporters", "data")
    ...
    data: _k8s_cluster_detail_pb2.K8sClusterDetail
    def __init__(self, metadata: _Optional[_Union[_metadata_pb2.Metadata, _Mapping]] = ..., reporter_data: _Optional[_Union[_reporter_data_pb2.ReporterData, _Mapping]] = ..., reporters: _Optional[_Iterable[_Union[_reporter_data_pb2.ReporterData, _Mapping]]] = ..., data: _Optional[_Union[_k8s_cluster_detail_pb2.K8sClusterDetail, _Mapping]] = ...) -> None: ...
