...
class K8sCluster(_message.Message):
    __slots__ = ("id", "resource_type", "first_reported", "first_reported_by", "latest_reported", "latest_reported_by", "workspace", "reporter_data", "reporters", "tags", "Data")
