...
class ReporterData(_message.Message):
    __slots__ = ("reporter_type", "reporter_is", "console_href", "api_href", "resourceid_alias", "reporter_version")
    ...
    REPORTER_IS_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, reporter_type: _Optional[_Union[ReporterData.Reporter_typeEnum, str]] = ..., reporter_is: _Optional[str] = ..., console_href: _Optional[str] = ..., api_href: _Optional[str] = ..., resourceid_alias: _Optional[str] = ..., reporter_version: _Optional[str] = ...) -> None: ...
