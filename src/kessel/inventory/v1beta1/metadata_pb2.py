...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_METADATA'].fields_by_name['latest_reported_by']._loaded_options = None
  _globals['_METADATA'].fields_by_name['latest_reported_by']._serialized_options = b'\342A\001\003'
